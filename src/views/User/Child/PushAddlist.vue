<template>
  <div class="pushAddlist" :style="{minHeight:dataListHeight}">
    <div class="myAddress_top">
      <!-- <van-icon name="arrow-left" @click="goBack" />
      <div class="toptitle">新增地址</div>-->
...
export default {
  ...
  data() {
    return {
      value: "",
      api: {
        pushAddlist: `/api/shoppe-api-service/mobile/address/create`,
      },
      areaList: {},
      show: false,
      searchResult: [],
  ...
  methods: {
    ...
    onSubmit(values) {
      ...
      postFunction(this.api.pushAddlist, this.list).then((res) => {
        if (res.code == "000000") {
          this.$router.push({
            name: "MyAddress",
